...
janin.currency = {
    createCurrency: function (name, networkVersion, privateKeyPrefix, WIF_Start, CWIF_Start, donate, scriptHash, b32hrp) {
        var currency = {
    ...
    networkVersion: function () {
        return janin.selectedCurrency.pubKeyHash;
    },

    privateKeyPrefix: function () {
        return janin.selectedCurrency.wif;
    },
...
janin.currencies = [
    ...
    janin.currency.createCurrency("Bellcoin", 0x19, 0x80, "5", "[LK]", "BEDspA3yyg8LhzLA75e8J1kR7bSiMAMmXb", 0x55, "bm"),
    janin.currency.createCurrency("Bitcoin", 0x00, 0x80, "5", "[LK]", "15DHZzv7eBUwss77qczZiL3DUEZLjDYhbM", 0x05, "bc"),
    ...
    janin.currency.createCurrency("BitZeny", 0x51, 0x80, "5", "[LK]", "ZxUsfFszPsKdot4XnoZHZcMKg2PPS3NUji", 0x05, "sz"),
    ...
    janin.currency.createCurrency("Kagonmacoin", 0x2d, 0x80, "5", "[LK]", ""), // WIF UNKNOWN
    ...
    janin.currency.createCurrency("Koto", 0x1836, 0x80, "5", "[LK]", "k1CgSBTwDC79jm1Kucox2DdCakCd2Z9HarJ"),
    ...
    janin.currency.createCurrency("Litecoin", 0x30, 0xb0, "6", "T", "LiScnsyPcqsyxn1fx92BcFguryXcw4DgCy", 0x05, "ltc"),
    ...
    janin.currency.createCurrency("MiningEnthusiastCoin", 0x30, 0xb0, "6", "T", ""),
    ...
    janin.currency.createCurrency("Monacoin", 0x32, 0xb0, "6", "T", "MPE8npAXs49HMpQGkETFqBa8GBzsRM5FJn", 0x37, "mona"),
    ...
    janin.currency.createCurrency("NAMAPOSTAMP", 0x35, 0x80, "5", "[LK]", ""),
    ...
    janin.currency.createCurrency("Ringo", 0x3c, 0x80, "5", "[LK]", ""), // WIF UNKNOWN
    ...
    janin.currency.createCurrency("SanDeGo", 0x3f, 0x80, "5", "[LK]", ""), // WIF UNKNOWN
    ...
    janin.currency.createCurrency("SELN", 0x3f, 0x4b, "3", "C", ""),
    ...
    janin.currency.createCurrency("Sprouts", 0x3f, 0x80, "5", "[LK]", ""), // WIF UNKNOWN
    ...
    janin.currency.createCurrency("Susucoin", 0x3f, 0x80, "5", "[LK]", ""),
    ...
    janin.currency.createCurrency("XPChain", 0x4c, 0x80, "5", "[LK]", ""),
    janin.currency.createCurrency("Yenten", 0x4e, 0x7b, "5", "K", "YStuCpv1U9iT3L1VqBr52B9nBxrNgt4Fpj"),
    janin.currency.createCurrency("Yajucoin", 0x4e, 0x80, "5", "[LK]", ""), // WIF UNKNOWN
