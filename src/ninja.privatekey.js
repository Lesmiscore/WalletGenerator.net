...
const BIP38EncryptedKeyToByteArrayAsync = function(
  base58Encrypted,
  passphrase,
  callback
) {
...
const BIP38PrivateKeyToEncryptedKeyAsync = function(
  base58Key,
  passphrase,
  compressed,
  callback
...
const BIP38GenerateIntermediatePointAsync = function(
  passphrase,
  lotNum,
  sequenceNum,
  callback
...
const BIP38GenerateECAddressAsync = function(
  intermediate,
  compressed,
  callback
) {
