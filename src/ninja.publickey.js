...
const getBitcoinAddressFromByteArray = function(pubKeyByteArray) {
...
const getByteArrayFromAdding = function(pubKeyHex1, pubKeyHex2) {
...
const getByteArrayFromMultiplying = function(pubKeyHex, ecKey) {
...
module.exports = {
  ...
  getBitcoinAddressFromByteArray,
  getHexFromByteArray,
  getByteArrayFromAdding,
  getByteArrayFromMultiplying
};
